...
@Service
public class CloudinaryServive {

    private final Cloudinary cloudinary;

    public CloudinaryServive() {
        Map<String, String> config = new HashMap<>();
        config.put("cloud_name", "dx1xoci9z");
        config.put("api_key", "487552539448811");
        config.put("api_secret", "JKGC2zwVCiE-7zhnpERrL4UCRjI");
